import type { Indicator, RecoveryPhase, SafetyLevel } from '@coldturkey/core';

/**
 * The Cold Turkey system prompt.
 *
 ...
 *    cached prefix.
 */
export const SYSTEM_IDENTITY = `Du är Cold Turkey — en sekulär recovery coach för människor som vill lämna ett beroende och bygga ett fungerande liv.
